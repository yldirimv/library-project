        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationBanUntil = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LoanBanUntil = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LoyaltyTransactions_AspNetUsers_VisitorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookLoans_AspNetUsers_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookLoans_AspNetUsers_VisitorId",
                        column: x => x.VisitorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GiftRequests_AspNetUsers_VisitorId",
                        column: x => x.VisitorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NoiseReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NoiseReports_AspNetUsers_VisitorId",
                        column: x => x.VisitorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NoiseReports_Seats_SeatId",
                        column: x => x.SeatId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GiftRequests_VisitorId",
                table: "GiftRequests",
                column: "VisitorId");

            migrationBuilder.CreateIndex(
                name: "IX_LoyaltyTransactions_VisitorId",
                table: "LoyaltyTransactions",
                column: "VisitorId");

            migrationBuilder.CreateIndex(
                name: "IX_NoiseReports_SeatId",
                table: "NoiseReports",
                column: "SeatId");

            migrationBuilder.CreateIndex(
                name: "IX_NoiseReports_VisitorId",
                table: "NoiseReports",
                column: "VisitorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_SeatId_StartTime",
                table: "Reservations",
                columns: new[] { "SeatId", "StartTime" });
